...
CREATE TABLE `boitier`(
    ...
    `fenetre` varchar(255) NOT NULL,
    `watercooling` varchar(255) NOT NULL,
    `alim_fournie` varchar(255) NOT NULL,
    `systeme_fixation_sans_vis` varchar(255) NOT NULL,
...
CREATE TABLE `carte_graphique`(
    ...
    `marque` varchar(255) NOT NULL,
    `prix` int(11) NOT NULL,
    `overclock` varchar(255) NOT NULL,
...
CREATE TABLE `processeur`(
    ...
    `tdp` int(11) NOT NULL,
    `version_boite` varchar(255) NOT NULL,
    `finesse_gravure` int(11) NOT NULL,
    `controleur_integre` varchar(255) NOT NULL,
...
CREATE TABLE `carte_mere`(
    ...
    `raid_support` varchar(255) NOT NULL,
...
CREATE TABLE `alimentation`(
    ...
    `silencieux` varchar(255) NOT NULL,
